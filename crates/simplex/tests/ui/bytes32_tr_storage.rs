...
fn main() -> Result<(), String> {
    ...
    for seed in 0..32 {
        ...
        let original_witness =
            derived_bytes32_tr_storage::Bytes32TrStorageWitness::generate_witness_raw(&mut rng);
        ...
        let rand_raw_witness_values =
            derived_bytes32_tr_storage::Bytes32TrStorageWitness::generate_witness(&mut rng);
