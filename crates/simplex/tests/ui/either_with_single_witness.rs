...
fn test_e2e_random_value_generation_behaviour() -> Result<(), String> {
    for seed in 0..32 {
...

        {
            ...
            let _ = derived_either_with_single_witness::EitherWithSingleWitnessWitness::from_witness(&witness_values)?;
        }

        {
            ...
            let _ = derived_either_with_single_witness::EitherWithSingleWitnessArguments::from_arguments(
                &arguments_values,
            )?;
        }
    }
